            ...
            <div className='flex items-center gap-6 relative'>
                ...
                <div className='relative'>
                    <button 
                        ...
                        className='w-9 h-9 bg-black text-white rounded-full cursor-pointer flex items-center justify-center font-semibold'>
                    ...
                    {showUserPopup && (
                        <div className='absolute right-0 mt-3 w-48 bg-white shadow-xl border border-gray-200 rounded-xl p-4'>
                            ...
                            <button onClick={() => navigate("/history")} 
                                    className='w-full text-left text-sm py-2 hover:text-black cursor-pointer text-gray-600'
                                    >InterView History</button>
                            <button 
                                onClick={handleLogout}
                                className='w-full text-left text-sm py-2 flex items-center gap-2 cursor-pointer text-red-500'>
